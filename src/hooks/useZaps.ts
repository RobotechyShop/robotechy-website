...
export function useZaps(
  ...
  const zap = async (amount: number, comment: string) => {
    ...
    try {
      ...
      // nostr-tools ≥2.20 takes the whole event and derives the tags itself:
      // 'p' + 'e' always, the correct 'a' coordinate for replaceable/addressable
      // kinds, and the NIP-57 'k' tag — replacing our old manual kind branching.
