...
const SignupDialog: React.FC<SignupDialogProps> = ({ isOpen, onClose, onComplete }) => {
  const [step, setStep] = useState<'welcome' | 'generate' | 'download' | 'profile' | 'done'>(
    'welcome'
  );
  ...
  const getTitle = () => {
    if (step === 'welcome')
      return <span className="flex items-center justify-center gap-2">Create Your Account</span>;
    if (step === 'generate')
      return <span className="flex items-center justify-center gap-2">Generating Your Key</span>;
    if (step === 'download')
      return <span className="flex items-center justify-center gap-2">Secret Key</span>;
    if (step === 'profile')
      return <span className="flex items-center justify-center gap-2">Create Your Profile</span>;
    return <span className="flex items-center justify-center gap-2">Welcome!</span>;
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className={cn(
          'max-w-[95vw] sm:max-w-md max-h-[90vh] max-h-[90dvh] p-0 overflow-hidden rounded-2xl flex flex-col'
        )}
      >
                ...
                <div className="relative z-10">
                  {isLoading ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <p className="text-lg font-semibold">Ready to generate your secret key?</p>
                        <p className="text-sm text-muted-foreground px-5">
                          This key will be your password to access applications within the Nostr
                          network.
                        </p>
                      </div>
                    </div>
            ...
            <div className="text-center space-y-4">
              ...
              <div className="relative p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950/50 dark:to-indigo-950/50 overflow-hidden">
                ...
                <div className="absolute inset-0 pointer-events-none">
                  ...
                  />
                  <Sparkles
                    className="absolute bottom-3 right-4 w-3 h-3 text-yellow-500 animate-pulse"
                ...
                <div className="relative z-10 space-y-2">
                  <p className="text-base font-semibold">Your secret key has been generated!</p>
                  ...
                  <div className="relative mx-auto max-w-sm">
                    <div className="p-3 bg-gradient-to-r from-amber-100 via-yellow-50 to-amber-100 dark:from-amber-950/40 dark:via-yellow-950/20 dark:to-amber-950/40 rounded-lg border-2 border-amber-300 dark:border-amber-700 shadow-md">
                      ...
                      <p className="text-xs text-red-700 dark:text-amber-300 italic">
                        This key is your primary and only means of accessing your account. Store it
                        safely and securely.
                      </p>
                    </div>
                  </div>
                      ...
                      >
                        <div className="flex items-center gap-3 w-full">
                          ...
                          <div className="flex-1 text-left">
                            <div className="font-medium text-sm">Download as File</div>
                            <div className="text-xs text-muted-foreground">
                              Save as nostr-nsec-key.txt file
                            </div>
                          </div>
                          {keySecured === 'downloaded' && (
                            <div className="text-xs font-medium text-green-600">✓ Downloaded</div>
                          )}
                        </div>
                      </Button>
                    </CardContent>
          ...
          {step === 'profile' && (
            <div className="text-center space-y-4">
              ...
              <div className="relative p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950/50 dark:to-indigo-950/50 overflow-hidden">
                ...
                <div className="relative z-10 space-y-2">
                  <p className="text-base font-semibold">Almost there! Let's set up your profile</p>
              ...
              {/* Profile form */}
              <div
                className={`space-y-4 text-left ${isPublishing ? 'opacity-50 pointer-events-none' : ''}`}
              >
                <div className="space-y-2">
