        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 max-w-md mb-4">
              ...
              . I'm currently studying at college, where I'm pursuing my interest in engineering
              and CAD design. I love 3D printing and building things for the Bitcoin community!
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
              ...
              <li><a href="/custom-3d-prints" className="hover:text-robotechy-blue transition-colors">Custom 3D Prints</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-3 text-slate-900 dark:text-white">Policies</h4>
            <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
              <li><a href="/shipping-policy" className="hover:text-robotechy-blue transition-colors">Shipping</a></li>
              <li><a href="/refund-policy" className="hover:text-robotechy-blue transition-colors">Refunds</a></li>
              <li><a href="/privacy-policy" className="hover:text-robotechy-blue transition-colors">Privacy</a></li>
              <li><a href="/terms-of-service" className="hover:text-robotechy-blue transition-colors">Terms of Service</a></li>
            </ul>
          </div>
        </div>
        {/* Social Links */}
