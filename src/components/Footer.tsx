...
export function Footer({ selectedCollection, onCollectionClick }: FooterProps) {
  ...
  return (
    <footer className="border-t bg-slate-50 dark:bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <ul className="space-y-2 text-sm text-sage-600 dark:text-sage-400">
              <li>
                <button
                  ...
                  className={`hover:text-robotechy-green-dark transition-colors ${!selectedCollection && onCollectionClick ? 'text-robotechy-green-dark font-medium' : ''}`}
                >
                  All Products
                </button>
              </li>
                ...
                return (
                  <li key={d}>
                    <button
                      ...
                      className={`hover:text-robotechy-green-dark transition-colors ${selectedCollection === d ? 'text-robotechy-green-dark font-medium' : ''}`}
                    >
                      {title}
                    </button>
                  </li>
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-wrap justify-center gap-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sage-600 dark:text-sage-400 hover:text-red-600 transition-colors"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sage-600 dark:text-sage-400 hover:text-black dark:hover:text-white transition-colors"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sage-600 dark:text-sage-400 hover:text-slate-900 dark:hover:text-white transition-colors"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800 text-center text-sm text-sage-600 dark:text-sage-400">
          <p>
            Powered by{' '}
            <a
